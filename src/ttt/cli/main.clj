...
(def help-text
  (str/join
   ...
   ["ttt"
    ...
    ""
    "Setup:"
    "  ttt setup          Configure Linear or GitHub Issues and check gh auth"
    ""
...
(defn llm-doc
  ...
  (str/join
   ...
   ["# tickettrain"
    ""
    (str "`ttt` (tickettrain) links the current GitHub pull request with Linear or GitHub Issues items. "
    ...
    "- Linear credentials are configured when Linear is the tracker"
    ""

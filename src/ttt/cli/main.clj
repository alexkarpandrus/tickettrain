...
(defn llm-doc
  ...
  (str/join
   ...
   ["# tickettrain"
    ...
    "- For Linear, run `LINEAR_STATE_NAME=\"Exact team state\" ttt setup` to validate and persist a remap. Run interactive setup and choose `Linear default` to omit an explicit state."

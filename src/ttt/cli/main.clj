...
(def help-text
  (str/join
   ...
   ["ttt"
    ...
    ""
    "Setup:"
    "  ttt setup          Configure Linear, GitHub Issues, or Jira and check gh auth"
    ""
...
(defn llm-doc
  ...
  (str/join
   ...
   ["# tickettrain"
    ""
    (str "`ttt` (tickettrain) links the current GitHub pull request with Linear, GitHub Issues, or Jira items. "

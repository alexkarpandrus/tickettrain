...
(defn llm-doc
  ...
  (str/join
   ...
   ["# tickettrain"
    ...
    "- Comment previews include the exact target and comment body. Change-request update previews include the exact target and `changeRequestUpdate`. Link previews include `approvalContext`, `item`, `trackerIntent`, and `changeRequestUpdate`; create previews include `changeRequestIntent`."
    ""
    "## Managed metadata"
    ""
